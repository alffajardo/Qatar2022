...
picks_id <- drive_find(type = "spreadsheet",pattern = "KO_Stage4_respuestas",
n_max = 1)$id
...
write.table(bets,"KO4_picks.csv",sep=",",
quote = F,
row.names =F )


write.table(scores_prediction,"KO4_predicted_scores.csv",sep=",",
            quote = F,
            row.names =F )
...
ggsave("picks_KO4.png",plot = plot1,units = "px",width = 1200,height = 1200,
